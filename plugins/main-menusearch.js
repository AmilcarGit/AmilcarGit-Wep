...
const handler = async (m, { conn, usedPrefix: _p }) => {
 ...
 ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊ ♡ °̩̥˚̩̩̥͙°̩̥ ·͙*̩̩͙˚̩̥̩̥*̩̩̥͙·̩̩̥͙*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙ °̩̥˚̩̩̥͙°̩̥ ♡ ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊
  ...
  ☯︎ *HERRAMIENTAS DE BÚSQUEDA:*
  🔍 Busca en internet, descarga contenido y más.
...
`
    ...
    console.error('💥 Error en menú buscador:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de búsqueda.`, m)
  }
}
