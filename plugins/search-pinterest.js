...
handler.help    = ['pinterest <búsqueda o link>']
handler.command = ['pinterest', 'pin']
handler.tags    = ['search']
handler.desc    = 'Busca y descarga imágenes de Pinterest'

export default handler

async function dl(url) {
  try {
    const res = await axios.get(url, { headers: { 'User-Agent': 'Mozilla/5.0' } }).catch(e => e.response)
