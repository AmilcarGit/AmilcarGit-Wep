...
const handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const help = Object.values(global.plugins || {})
      .filter(p => !p.disabled && p.tags && p.tags.includes('grupo'))
      .map(p => ({
    ...
    const totalComandosGrupo = help.length
 ...
 ❛ ━━━━━━･❪ ♨︎ ❫ ･━━━━━━ ❜
   🂡𝐓 𝐇 𝐄 𝐄 𝐋 𝐘 𓆆 𝐌 𝐃
   ─── 𝑨𝒅𝒎𝒊𝒏𝒊𝒔𝒕𝒓𝒂𝒄𝒊𝒐́𝒏 𝒅𝒆 𝑮𝒓𝒖𝒑𝒐𝒔 ───
 ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊ ♡ °̩̥˚̩̩̥͙°̩̥ ·͙*̩̩͙˚̩̥̩̥*̩̩̥͙·̩̩̥͙*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙ °̩̥˚̩̩̥͙°̩̥ ♡ ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊

  🌼 *¡Hola,* *${name}!*
   ${getGreeting(horaPeru.getHours())}

  ♨︎ *ADMINISTRACIÓN DE GRUPOS:*
  👥 Grupos totales: ${totalGrupos}
  🛠️ Comandos disponibles: ${totalComandosGrupo}
...
`
    ...
    console.error('💥 Error en menú grupos:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de administración de grupos.`, m)
  }
}
