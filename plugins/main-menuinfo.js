...
const handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const totalInfoCmds = help.length
...
`
    ...
    console.error('💥 Error en menú información:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de información.`, m)
  }
}

handler.command = ['menuinfo', 'info', 'informacion']
handler.tags = ['main']
