...
const handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    const help = Object.values(global.plugins || {})
      .filter(p => !p.disabled && p.tags && p.tags.includes('jadibot'))
      .map(p => ({
 ...
 ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊ ♡ °̩̥˚̩̩̥͙°̩̥ ·͙*̩̩͙˚̩̥̩̥*̩̩̥͙·̩̩̥͙*̩̩̥͙˚̩̥̩̥*̩̩͙‧͙ °̩̥˚̩̩̥͙°̩̥ ♡ ‧̍̊·̊‧̥°̩̥˚̩̩̥͙°̩̥‧̥·̊‧̍̊
  ...
  ☘️ *ESTADO DE SUB-BOTS:*
  🤖 Sub-Bots activos: ${totalSubBots}
  ⚡ Límite por usuario: 5
...
`
    ...
    console.error('💥 Error en menú sub-bots:', e)
    await conn.reply(m.chat, `❌ Ocurrió un error al cargar el menú de sub-bots.`, m)
  }
}
